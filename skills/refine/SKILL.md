...
1. **Pattern Health Check**
   - List patterns in `memory/patterns/` by usage_count (desc)
...
3. **Gap Analysis**
   - Cross-reference work-type coverage
...
2. **Create ADR Draft**
   ...
   - Use template from `dev_communication/shared/architecture/templates/adr-template.md`
   - Save to `dev_communication/shared/architecture/decisions/`
...
1. Move from `memory/patterns/` to `memory/patterns/archived/`
2. Update indexes
